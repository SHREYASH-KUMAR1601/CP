...
int countSuneetWins(int a1, int a2, int b1, int b2) {
    ...
    for (int i = 0; i < 2; ++i) {
        for (int j = 0; j < 2; ++j) {
            ...
            if (suneetFirst > slavicFirst) suneetWins++;
            else if (suneetFirst < slavicFirst) slavicWins++;

            if (suneetSecond > slavicSecond) suneetWins++;
            else if (suneetSecond < slavicSecond) slavicWins++;
